        ...
        <div className="w-full">
            <div className="mx-auto max-w-screen-2xl px-6 lg:px-10 xl:px-20 flex flex-col sm:flex-row justify-between sm:items-center py-16 xl:py-10 gap-10 sm:gap-0">
                ...
                <div className="sm:w-1/2 flex gap-3 items-center">
                    {/* <Image unoptimized={true} src={`${process.env.NEXT_PUBLIC_CMS_URL}${videoSection.leftImage.url}`} width={300} height={600} alt={`${process.env.NEXT_PUBLIC_CMS_URL}${videoSection.leftImage.hash}`} className="rounded-3xl w-1/4 h-auto" /> */}
                    <Image unoptimized={true} src={`/images/firstImage.png`} width={300} height={600} alt={`first image`} className="rounded-3xl w-1/4 h-auto" />
                    <video muted={true} autoPlay={true} loop={true} className="rounded-3xl w-2/5 h-auto" playsInline={true}>
                    ...
                    {/* <Image unoptimized={true} src={`${process.env.NEXT_PUBLIC_CMS_URL}${videoSection.rightImage.url}`} width={300} height={600} alt={`${process.env.NEXT_PUBLIC_CMS_URL}${videoSection.rightImage.hash}`} className="rounded-3xl w-1/4 h-auto" /> */}
